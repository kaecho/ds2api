...
- `docs/overview.md` / `docs/overview.en.md`：面向首次接触用户，保留“是什么 + 怎么快速跑起来”。
...
1. [Project overview](./overview.en.md)
...
- `docs/overview.md` / `docs/overview.en.md`: onboarding-oriented (“what + quick start”).
